        ...
        <Row id="contact" className="footer-wrapper">
            <Col className="footer-item" span={8}>
                ...
                <div className="footer-text">
                    {t("Website Accessibility Policy")}
                </div>
            </Col>
            <Col className="footer-item" span={8}>
            ...
            <Col className="footer-item" span={8}>
                ...
                <div className="footer-icon">
                    <Tippy
                        render={(attr) => (
                            <div className="footer-media">Facebook</div>
                        )}
                        animation={false}
                ...
                <div className="footer-icon">
                    <Tippy
                        render={(attr) => (
                            <div className="footer-media">Twitter</div>
                        )}
                        animation={false}
                        placement={"right-start"}
                    >
                ...
                <div className="footer-icon">
                    <Tippy
                        render={(attr) => (
                            <div className="footer-media">Youtube</div>
                        )}
                        animation={false}
                        placement={"right-start"}
                    >
                ...
                <div className="footer-icon">
                    <Tippy
                        render={(attr) => (
                            <div className="footer-media">TikTok</div>
                        )}
                        animation={false}
                        placement={"right-start"}
                    >
