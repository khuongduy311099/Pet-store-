...
function Cagetory({listItem}) {
    ...
    const handleFilterDog = (value, type) => {
        ...
        if (dogFilter1.popularity !== "0") {
            list = list.filter(
                (item) => item.popularity === dogFilter1.popularity
            );
        }
    ...
    const handleFilterCat = (value, type) => {
        ...
        if (catFilter1.popularity !== "0") {
            list = list.filter(
                (item) => item.popularity === catFilter1.popularity
            );
        }
                            ...
                            <Row style={{marginBottom: "10px"}}>
                                <Col className="select-wrapper" span={8}>
                                    <Select
                                        ...
                                        className="filter-box-select"
                                        onChange={(value) =>
                                            handleFilterDog(value, "popularity")
                                        }
                                        options={[
                                            {
                                                value: "Hot",
                                ...
                                <Col className="select-wrapper" span={8}>
                                    <Select
                                        ...
                                        className="filter-box-select"
                                        onChange={(value) =>
                                            handleFilterDog(value, "activity")
                                        }
                                        options={[
                                            {
                                                value: "Low",
                            ...
                            <Row style={{marginBottom: "10px"}}>
                                <Col className="select-wrapper" span={8}>
                                    <Select
                                        ...
                                        className="filter-box-select"
                                        onChange={(value) =>
                                            handleFilterCat(value, "popularity")
                                        }
                                        options={[
                                            {
                                                value: "Hot",
                                ...
                                <Col className="select-wrapper" span={8}>
                                    <Select
                                        ...
                                        className="filter-box-select"
                                        onChange={(value) =>
                                            handleFilterCat(value, "hairFall")
                                        }
                                        options={[
                                            {
                                                value: "Low",
